...
public:
    ...
    void Init(IDirect3DDevice9 *pD3d, const std::string& pFilename);
...
public:
    ...
    void                WriteTAILine(CmdLineOptionCollection const &options, FILE *fp, LONG margin) const;

    AtlasObject const* GetAtlas() const { return mpAtlas; }
